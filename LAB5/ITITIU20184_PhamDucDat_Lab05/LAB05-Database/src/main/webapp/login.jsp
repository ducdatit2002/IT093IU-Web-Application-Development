...
<html>
    ...
    <body>
        ...
        %>
        <%
            String connectionURL = "jdbc:mysql://localhost:3306/lab5-jdbc"; //step 2
        ...
        <%
            if (cUsername == null || cPass == null) {
                out.println("<h1 style=\"color:#8b2f8a; text-align: center;\">Edusoft Web HCMIU Edu VN</h1>"
                        ...
                        + "        <tr>\n"
                        + "            <td>Student's ID</td>\n"
                        + "            <td><input class=\"form-control\" type=\"text\" name=\"username\" placeholder=\"ITITIU20184\" required></td>\n"
                        + "        </tr>\n"
                        + "        <tr>\n"
                        + "            <td>Password</td>\n"
